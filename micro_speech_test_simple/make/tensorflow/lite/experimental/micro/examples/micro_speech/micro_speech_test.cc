...
TF_LITE_MICRO_TEST(TestInvoke) {
  ...
  const uint8_t* yes_features_data = g_no_micro_f9643d42_nohash_4_data; //g_yes_micro_f2e59fea_nohash_1_data;
  ...
  const uint8_t* no_features_data = g_yes_micro_f2e59fea_nohash_1_data; //g_no_micro_f9643d42_nohash_4_data;
  for (int i = 0; i < input->bytes; ++i) {
