...
// Causes a board RESET when the A button is pressed
// GPIO 59 needs to be connected to SYS_RST_B
// On RDB that is: Header 1 Pin 1 connected to Header 1 Pin 3
// LED blinks to show board is operational. It stops blinking as board resets
//
...
{
    Log_Debug("RESET test application starting.\n");
