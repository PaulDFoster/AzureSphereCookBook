...
ADD_COMPILE_OPTIONS( -mthumb -Os -std=c++11 -fpermissive -fno-exceptions -g -DTF_LITE_STATIC_MEMORY -Wall ${COMPILE_DEBUG_FLAGS} ${COMPILE_RELEASE_FLAGS})

#ADD_COMPILE_OPTIONS(-std=c++11 -fpermissive -fno-exceptions -fno-unwind-tables -g -DTF_LITE_STATIC_MEMORY -Wall $#{COMPILE_DEBUG_FLAGS} ${COMPILE_RELEASE_FLAGS})